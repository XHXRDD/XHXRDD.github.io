...
JSIndexScript.prototype.MA=function()
{
    let data=
    {
        ...
        Args:[ { Name:'M1', Value:5}, { Name:'M2', Value:34 }, { Name:'M3', Value:170} ],
        OutName:[ {Name:'MA1',DynamicName:"MA{M1}" },  {Name:'MA2',DynamicName:"MA{M2}" },{Name:'MA3',DynamicName:"MA{M3}" }],
        Script: //脚本
'MA1:MA(CLOSE,M1),COLORGREEN,LINETHICK1;\n\
MA2:MA(CLOSE,M2),RGB(244, 55, 244), LINETHICK2;\n\
MA3:MA(CLOSE,M3),COLORWHITE,LINETHICK3;'

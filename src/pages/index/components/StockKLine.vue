...
export default 
{
    ...
    methods:
    {
            ...
            $.ajax({
                ...
                success: function (data) 
                {
                    if(data.code == 0){
                        ...
                        window.open('http://push2his.eastmoney.com/' + relativeUrl);
                    }
                },
        ...
        SetDefaultKLineOption:function(option)
        {
            ...
            if (option.NetworkFilter) this.KLine.Option.NetworkFilter = option.NetworkFilter;
        },
